...
Por tanto, tenemos que definir los conceptos a aprender y el conjunto de entrenamiento. Así, se describirá la base de datos ``ImageNet''\todo[color=red!50]{Citar a Imagenet} y la competición ILSVRC\todo[color=red!50]{Citar a ILSVRC}. Además, se hablará de la librería usada para el entrenamiento, Caffe \todo[color=red!50]{citar Caffe} y el modelo adoptado, una adaptación del modelo Alexnet\todo[color=red!50]{Citar a alexnet}.\\
